...
const config: Config = {
  ...
  organizationName: 'wacif', // Your GitHub org/user name.
  projectName: 'ai-native-hackathon', // Your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/wacif/ai-native-hackathon/tree/main/',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/wacif/ai-native-hackathon',
          label: 'GitHub',
          position: 'right',
        },
      ],
